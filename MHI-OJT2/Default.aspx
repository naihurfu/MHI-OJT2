...
<asp:Content ID="ScriptContent" ContentPlaceHolderID="script" runat="server">
    ...
    <script type="text/javascript">
        (function () {
            ...
            $.ajax({
                type: "POST",
                url: "<%= ajax %>" + "/Default.aspx/GetChart",
                data: data,
        ...
        function PreloadCardCountData() {
            ...
            $.ajax({
                type: "POST",
                url: "<%= ajax %>" + "/Default.aspx/GetAllCourseCountTable",
                data: data,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (results) {
            ...
            $.ajax({
                type: "POST",
                url: "<%= ajax %>" + "/Default.aspx/GetTrainedThisYearTable",
                data: data,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (results) {
            ...
            $.ajax({
                type: "POST",
                url: "<%= ajax %>" + "/Default.aspx/GetWaitForEvaluationTable",
                data: data,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (results) {
            ...
            $.ajax({
                type: "POST",
                url: "<%= ajax %>" + "/Default.aspx/GetWaitForApprovalTable",
                data: data,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (results) {
        ...
        function HandleDataShowInTable(items) {
            ...
            items.forEach((item, index) => {
                let startDate = new Date(item.START_DATE).toLocaleDateString("en-US")
                var tableRow = `<tr>
                                            <td class="text-center">
                                                ${index + 1}
                                            </td>
